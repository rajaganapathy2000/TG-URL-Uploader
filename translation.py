...
URL | filename | username | password"""
    NOYES_URL = "@SeriesDiscussionForum"
    DOWNLOAD_START = "trying to download"
    UPLOAD_START = "trying to upload"
    RCHD_BOT_API_LIMIT = "size greater than maximum allowed size (50MB). Neverthless, trying to upload."
    RCHD_TG_API_LIMIT = "Downloaded in {} seconds.\nDetected File Size: {}\nSorry. But, I cannot upload files greater than 1.5GB due to Telegram API limitations."
    AFTER_SUCCESSFUL_UPLOAD_MSG = "Please rate me if you find me useful. Join : @SeriesDiscussionForum"
    AFTER_SUCCESSFUL_UPLOAD_MSG_WITH_TS = "Downloaded in {} seconds. \nJoin : @SeriesDiscussionForum \nUploaded in {} seconds."
...
"""
    ...
    FF_MPEG_RO_BOT_AD_VER_TISE_MENT = "https://t.me/SeriesDiscussionForum"
